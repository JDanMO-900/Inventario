          ...
          <v-container>
            ...
            <v-row class="pt-3">
              ...
              <v-col cols="12" sm="12" md="12">
                ...
                <base-input label="Ingrese el nombre del usuario" v-model="v$.editedItem.name.$model"
              ...
              <v-col cols="12" sm="12" md="12">
                ...
                <base-input label="Ingrese el correo electronico" v-model="v$.editedItem.email.$model"
              ...
              <v-col cols="6" sm="12" md="12">
                <base-select label="Seleccione el rol del usuario" :items="this.role" item-title="name"
                  v-model.trim="v$.editedItem.role_id.$model" :rules="v$.editedItem.role_id">
                </base-select>
              </v-col>
              <!-- role -->
